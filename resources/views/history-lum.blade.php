...
<!-- Page Title -->
@section('title', 'Histórico da luminosidade')
<!-- Page Content -->
@section('content')
<!-- Begin Page Content -->
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mb-0 text-gray-800">Histórico da luminosidade</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success">Listagem do histórico da luminosidade</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive p-1">
                <table class="table table-bordered table-striped" id="table" width="100%">
                    ...
                    <tbody>
                        @foreach ($luminosities as $luminosity)
                        <tr>
                            <td>{{$luminosity->luminosity}}%</td>
                            <td class="text-capitalize">{{$luminosity->name}}</td>
                            <td>{{date_format($luminosity->created_at, "d/m/Y H:i")}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
