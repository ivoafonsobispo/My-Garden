...
<!-- Page Title -->
@section('title', 'Histórico da humidade')
<!-- Page Content -->
@section('content')
<!-- Begin Page Content -->
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mb-0 text-gray-800">Histórico da humidade</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success">Listagem do histórico da humidade</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-striped" id="table" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-capitalize">{{$humidity->name}}</td>
