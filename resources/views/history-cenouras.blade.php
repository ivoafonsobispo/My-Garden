            ...
            <div class="table-responsive p-1">
                <table class="table table-bordered table-striped" id="table" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$cenoura->temperature}}ºC</td>
                            <td>{{$cenoura->luminosity}}%</td>
                            <td>{{$cenoura->humidity}}%</td>
                            <td class="{{($cenoura->watering) ? "text-success" : " text-danger"}}">{{($cenoura->watering) ? "Ligada" : " Desligada"}}</td>
                            <td class="{{($cenoura->light) ? "text-success" : " text-danger"}}">{{($cenoura->light) ? "Ligada" : " Desligada"}}</td>
                            <td>{{date_format($cenoura->created_at, "d/m/Y H:i")}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
